...
/* Coefficient matrix for interpolating intensity and gradient */
{
	...
	mat g = { {-1, 6, -15, 20, -15, 6, -1},
			{-56, 144, -120, 0, 60, -36, 7},
			{-245, 90, 285, -180, -75, 90, -21},
			{0, -480, 0, 320, 0, -120, 35},
			{245, 90, -285, -180, 75, 90, -35},
			{56, 144, 120, 0, -60, -36, 21},
			{1, 6, 15, 20, 15, 6, -7},
			{0, 0, 0, 0, 0, 0, 1} };
	bsg_ = 7 * g;
}
